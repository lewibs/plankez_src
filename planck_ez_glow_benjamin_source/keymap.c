...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    ...
    KC_LCTRL,       KC_LALT,        MO(5),          KC_LSHIFT,      LOWER,          KC_SPACE,       KC_NO,          RAISE,          MO(4),          KC_RSHIFT,      KC_LGUI,        KC_RALT
  ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_F) SS_DELAY(STDSPEED) SS_TAP(X_O) SS_DELAY(STDSPEED) SS_TAP(X_R));

    }
    break;
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_E)) SS_DELAY(STDSPEED) SS_TAP(X_A) SS_DELAY(STDSPEED) SS_TAP(X_C) SS_DELAY(STDSPEED) SS_TAP(X_H));

    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_M) SS_DELAY(STDSPEED) SS_TAP(X_A) SS_DELAY(STDSPEED) SS_TAP(X_P));

    }
    break;
    case ST_MACRO_3:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_F) SS_DELAY(STDSPEED) SS_TAP(X_I) SS_DELAY(STDSPEED) SS_TAP(X_L) SS_DELAY(STDSPEED) SS_TAP(X_T) SS_DELAY(STDSPEED) SS_TAP(X_E));

    }
    break;
    case ST_MACRO_4:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_S) SS_DELAY(STDSPEED) SS_TAP(X_T) SS_DELAY(STDSPEED) SS_TAP(X_R) SS_DELAY(STDSPEED) SS_TAP(X_U) SS_DELAY(STDSPEED) SS_TAP(X_C));

    }
    break;
    case ST_MACRO_5:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_W) SS_DELAY(STDSPEED) SS_TAP(X_H) SS_DELAY(STDSPEED) SS_TAP(X_I) SS_DELAY(STDSPEED) SS_TAP(X_L) SS_DELAY(STDSPEED) SS_TAP(X_E));

    }
    break;
    case ST_MACRO_6:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_E) SS_DELAY(STDSPEED) SS_TAP(X_L) SS_DELAY(STDSPEED) SS_TAP(X_S) SS_DELAY(STDSPEED) SS_TAP(X_E) SS_DELAY(STDSPEED) SS_TAP(X_SPACE));

    }
    break;
    case ST_MACRO_7:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_I) SS_DELAY(STDSPEED) SS_TAP(X_F));

    }
    break;
    case ST_MACRO_8:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_T) SS_DELAY(STDSPEED) SS_TAP(X_R) SS_DELAY(STDSPEED) SS_TAP(X_Y));

    }
    break;
    case ST_MACRO_9:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_C) SS_DELAY(STDSPEED) SS_TAP(X_A) SS_DELAY(STDSPEED) SS_TAP(X_T) SS_DELAY(STDSPEED) SS_TAP(X_C) SS_DELAY(STDSPEED) SS_TAP(X_H));

    }
    break;
    case ST_MACRO_10:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_G) SS_DELAY(STDSPEED) SS_TAP(X_E) SS_DELAY(STDSPEED) SS_TAP(X_T));

    }
    break;
    case ST_MACRO_11:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_C) SS_DELAY(STDSPEED) SS_TAP(X_L) SS_DELAY(STDSPEED) SS_TAP(X_A) SS_DELAY(STDSPEED) SS_TAP(X_S) SS_DELAY(STDSPEED) SS_TAP(X_S));

    }
    break;
    case ST_MACRO_12:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_T) SS_DELAY(STDSPEED) SS_TAP(X_H) SS_DELAY(STDSPEED) SS_TAP(X_I) SS_DELAY(STDSPEED) SS_TAP(X_S) SS_DELAY(STDSPEED) SS_TAP(X_DOT));

    }
    break;
    case ST_MACRO_13:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_F) SS_DELAY(STDSPEED) SS_TAP(X_U) SS_DELAY(STDSPEED) SS_TAP(X_N) SS_DELAY(STDSPEED) SS_TAP(X_C));

    }
    break;
    case ST_MACRO_14:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_T) SS_DELAY(STDSPEED) SS_TAP(X_I) SS_DELAY(STDSPEED) SS_TAP(X_O) SS_DELAY(STDSPEED) SS_TAP(X_N));
